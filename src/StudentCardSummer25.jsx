    ...
    const studentsToRender = data.map((eachStudent) => {
        ...
        return (
            ...
            <div className="layout" key={Math.random()*100000}>
                ...
                <section><p key={eachStudent.id}className="student-name"> {eachStudent.names.preferredName}  {eachStudent.names.middleName} {eachStudent.names.surname}</p>
         ...
         &&eachStudent.certifications.github&& eachStudent.certifications.mockInterview?onTrack:offTrack}</p>
                    ...
                    <div id="table"><table key ={eachStudent.id}>
